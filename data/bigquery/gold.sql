-- encounter_summary
CREATE TABLE IF NOT EXISTS `silent-blade-487608-u0.gold_dataset.encounter_summary` (
    DepartmentID STRING,
...
TRUNCATE TABLE `silent-blade-487608-u0.gold_dataset.encounter_summary`;
...
CREATE TABLE IF NOT EXISTS `silent-blade-487608-u0.gold_dataset.provider_performance_summary` (
    ProviderID STRING,
    FirstName STRING,
    LastName STRING,
...
TRUNCATE TABLE `silent-blade-487608-u0.gold_dataset.provider_performance_summary`;

INSERT INTO `silent-blade-487608-u0.gold_dataset.provider_performance_summary`
SELECT
  p.ProviderID,
  p.FirstName,
  p.LastName,
...
-----------------------------
CREATE TABLE IF NOT EXISTS `silent-blade-487608-u0.gold_dataset.patient_billing_summary` (
    PatientID STRING,
    TotalEncounters INT,
    TotalBilled FLOAT64,
    TotalPaid FLOAT64,
...
TRUNCATE TABLE `silent-blade-487608-u0.gold_dataset.patient_billing_summary`;

INSERT INTO `silent-blade-487608-u0.gold_dataset.patient_billing_summary`
SELECT
  t.PatientID,
...
CREATE TABLE IF NOT EXISTS `silent-blade-487608-u0.gold_dataset.claims_summary_by_status_payor` (
    claim_status STRING,
    payor_type STRING,
    Year INT,
    TotalClaims INT,
...
TRUNCATE TABLE `silent-blade-487608-u0.gold_dataset.claims_summary_by_status_payor`;

INSERT INTO `silent-blade-487608-u0.gold_dataset.claims_summary_by_status_payor`
SELECT
  c.claim_status,
  c.payor_type,
